...
تم حجب القناة بسبب قيود متعلقة بصورة البروفايل، ولذلك تم ربط قناة استضافة. من كانوا في السابقة سيتم قبولهم بدون اي رسوم.

سيتم القبول لاحقا.
سيتم ربط القناة بقناة اخرى داخلها. سيتم تغيير النظام قريبا."""
